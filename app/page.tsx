...
const basePath = '/test-1775030701194';
...
export default function Home() {
  ...
  const submit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/01117957335?text=${msg}`, '_blank');
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Integrity</h4>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">info@example.com</p>
                  </div>
                </div>
                <div className="flex gap-6">
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-center gap-6">
            ...
            <a href={`https://wa.me/01117957335`} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">WhatsApp</a>
          </div>
